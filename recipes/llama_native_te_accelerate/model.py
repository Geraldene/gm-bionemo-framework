...
class NVLlamaPreTrainedModel(LlamaPreTrainedModel):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path=None, *model_args, config=None, **kwargs):
        ...
        # 'state_dict' can still be None if we failed to load from base.
        if state_dict and any("self_attn.q_proj" in k for k in state_dict.keys()):
        ...
        # Load NVLlama using (maybe) converted weights
